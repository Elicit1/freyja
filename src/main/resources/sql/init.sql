...
4. 【人设与稳定外貌提炼 (极重要)】：
   ...
   - 原著留白时的概念美术具象化补全：结合年龄段与内在性格，提炼具备视觉辨识度的【五官面容 + 发型体态】，不补写衣着造型：
      * 艺术媒介与风格忠实度 (核心铁律)：
        - 当全剧艺术载体为【2D 动漫 (2D Anime)】或创作者在视觉基调指南中指定了动画/动漫/漫画风格时：中文外貌 (appearanceDesc) 必须严格采用【2D 动漫概念美术设计 (2D Anime Character Design)】！突出动漫线条轮廓、发型体态与特色眼神，并融入创作者指定的调色与光影，严禁使用真人写实皮肤毛孔等真人词汇；
        - 当全剧艺术载体为【电影写实 (Cinematic Realism)】时：采用电影概念美术视角刻画写实五官骨相与体态；
        - 当全剧艺术载体为【3D 动画 (3D Animation)】时：采用次世代 3D 角色建模与精细材质视角；
      * 人物衣着、服装款式与造型设定由后续资产库维护，本阶段不得生成或传递；
    - 【极速省 Token 铁律】：
